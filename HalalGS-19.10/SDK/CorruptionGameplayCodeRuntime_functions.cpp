...
float UWarEffortFundingLibrary::GetIndexFundedPercent(const struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType)
{
	static class UFunction* Func = nullptr;
...
bool UWarEffortFundingLibrary::IsIndexFunded(const struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType)
{
	static class UFunction* Func = nullptr;
