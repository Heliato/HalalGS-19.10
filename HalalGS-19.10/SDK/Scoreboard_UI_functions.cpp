...
// bool                                    Param_IsRoundsGame                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function Scoreboard_UI.Scoreboard_UI_C.OnMinigameEnd__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UScoreboard_UI_C::OnMinigameEnd__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Scoreboard_UI_C", "OnMinigameEnd__DelegateSignature");
