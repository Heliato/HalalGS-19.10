...
// Function HorizontalTabList.HorizontalTabList_C.RefreshGamepad__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UHorizontalTabList_C::RefreshGamepad__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HorizontalTabList_C", "RefreshGamepad__DelegateSignature");
