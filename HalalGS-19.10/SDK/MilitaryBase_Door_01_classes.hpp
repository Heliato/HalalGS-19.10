...
public:
	...
	FMulticastInlineDelegateProperty_             OnDoorOpened;                                      // 0x0E78(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
