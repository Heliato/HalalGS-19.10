...
void UAthenaCustomizationSlotButtonWrapper_C::OnSlotClicked__DelegateSignature(class UCommonButtonLegacy* Button, const struct FAthenaCustomizationParams& CustomizationParams)
{
	static class UFunction* Func = nullptr;
