...
public:
	...
	static float GetIndexFundedPercent(const struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType);
	static bool IsIndexFunded(const struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType);
