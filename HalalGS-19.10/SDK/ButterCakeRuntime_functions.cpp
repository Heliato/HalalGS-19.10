...
struct FVector UFortButterCakeControlRig::GetGroundHitLocationAt(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
struct FVector UFortButterCakeControlRig::GetGroundHitNormalAt(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
