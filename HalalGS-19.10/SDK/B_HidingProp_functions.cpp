...
// Parameters:
// class AFortPawn*                        Param_Pawn                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Allow                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_HidingProp_C::Allow_Cosmetics_For_Pawn(const class AFortPawn*& Param_Pawn, bool* Allow)
{
	static class UFunction* Func = nullptr;
...
// class AActor*                           Param_Pawn                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPawn*                        Param_Pawn                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_HidingProp_C::StopHiding(const class AFortPawn* Param_Pawn)
{
	static class UFunction* Func = nullptr;
