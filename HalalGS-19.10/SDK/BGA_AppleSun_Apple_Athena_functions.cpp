...
// (Event, Public, BlueprintEvent)
// Parameters:
// struct FVector                          Param_BounceLocation                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   BounceIntensity                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABGA_AppleSun_Apple_Athena_C::DoBounceMulticast(const struct FVector& Param_BounceLocation, const float BounceIntensity, const class AActor* BouncingActor)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_BounceLocation = std::move(Param_BounceLocation);
	Parms.BounceIntensity = BounceIntensity;
