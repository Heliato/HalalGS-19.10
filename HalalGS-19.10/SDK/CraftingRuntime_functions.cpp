...
// Parameters:
// ECraftingObjectState                    CraftingState                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UCraftingObjectComponent::CraftingObjectStateChanged__DelegateSignature(ECraftingObjectState CraftingState, float CraftingStateStartTime, float CraftingStateDuration)
{
	static class UFunction* Func = nullptr;
	...
	Params::CraftingObjectComponent_CraftingObjectStateChanged__DelegateSignature Parms{};
