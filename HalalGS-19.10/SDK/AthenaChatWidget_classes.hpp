...
public:
	...
	FMulticastInlineDelegateProperty_             OnEnteredChat;                                     // 0x0390(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
