...
public:
	...
	static struct FTypedElementHandle GetElementHandleAt(const struct FTypedElementListProxy& ElementList, const int32 Param_Index);
	...
	static bool IsValidIndex(const struct FTypedElementListProxy& ElementList, const int32 Param_Index);
