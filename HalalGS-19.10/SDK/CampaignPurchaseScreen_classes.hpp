...
public:
	...
	class UMaterialInstanceDynamic*               MIDMinusKeyart;                                    // 0x03C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
