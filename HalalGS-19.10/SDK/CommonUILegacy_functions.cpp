...
void UCommonPopupMenuLegacy::SetContextProvider(const class UObject* Param_ContextProvidingObject)
{
	static class UFunction* Func = nullptr;
...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// class UWidget*                          InActiveWidget                                         (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UCommonWidgetSwitcherLegacy::SetActiveWidgetIndex_Advanced(const int32 Param_Index, const bool AttemptActivationChange)
{
	static class UFunction* Func = nullptr;
