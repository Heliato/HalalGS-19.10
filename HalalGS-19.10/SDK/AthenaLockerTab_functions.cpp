...
void UAthenaLockerTab_C::BeginPickingCustomization(class UCommonButtonLegacy* WidgetToReturnFocusTo, const struct FAthenaCustomizationParams& Param_CustomizationParams)
{
	static class UFunction* Func = nullptr;
