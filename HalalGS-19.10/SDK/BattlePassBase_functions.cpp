...
void UFortBattlePassCustomSkinCategoryTile::FocusTile(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassCustomSkinCategoryTile::SetPreviewedTile(const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
