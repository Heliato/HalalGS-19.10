...
public:
	...
	FMulticastInlineDelegateProperty_             OnOverlapWaterVolume;                              // 0x37C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
