...
struct FTypedElementHandle UTypedElementListLibrary::GetElementHandleAt(const struct FTypedElementListProxy& ElementList, const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::IsValidIndex(const struct FTypedElementListProxy& ElementList, const int32 Param_Index)
{
	static class UFunction* Func = nullptr;
