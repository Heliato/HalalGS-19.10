...
void AB_Galileo_Lobster_Block_Collision_C::BlockedLobsterImpulse(const struct FHitResult& HitInfo, class ACharacter* Param_Instigator)
{
	static class UFunction* Func = nullptr;
...
void AB_Galileo_Lobster_Block_Collision_C::ExecuteBlockGameplayCue(float Damage, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext, const struct FVector& ImpactColor, class AActor* Param_Instigator, const struct FHitResult& HitResult, bool* WasGalileoBun)
{
	static class UFunction* Func = nullptr;
...
void AB_Galileo_Lobster_Block_Collision_C::RemovalChecks(class AFortPlayerPawn* Param_PlayerPawn)
{
	static class UFunction* Func = nullptr;
