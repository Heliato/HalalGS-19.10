...
public:
	...
	FMulticastInlineDelegateProperty_             OnCloseSucceeded;                                  // 0x04F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
