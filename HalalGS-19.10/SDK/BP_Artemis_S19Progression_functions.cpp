...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_AllowBitArrayPopulation                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_Artemis_S19Progression_C::SetAllowBitArrayPopulation(bool Param_AllowBitArrayPopulation)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_AllowBitArrayPopulation = Param_AllowBitArrayPopulation;
...
void ABP_Artemis_S19Progression_C::SetSnowProgressionPhase(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
