...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UClass*                           Param_MobileInputStyle                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UInputReflectorButton_C::SetMobileStyle(class UClass* Param_MobileInputStyle)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MobileInputStyle = Param_MobileInputStyle;
