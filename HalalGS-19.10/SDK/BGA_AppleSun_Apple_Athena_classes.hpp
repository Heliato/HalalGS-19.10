...
public:
	...
	struct FGameplayTagContainer                  TC_CrashpadPlus;                                   // 0x0D40(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                         MinLaunch_CrashpadPlus;                            // 0x0D60(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                         MaxLaunch_CrashpadPlus;                            // 0x0D88(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
...
public:
	...
	void DestroyPad();
	void DoBounceMulticast(const struct FVector& Param_BounceLocation, const float BounceIntensity, const class AActor* BouncingActor);
