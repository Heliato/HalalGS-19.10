...
void ANPC_Pawn_Wildlife_Parent_C::CanBeInteractedWithWhenTamed(bool* Param_bCanInteract)
{
	static class UFunction* Func = nullptr;
...
// bool                                    Param_Enter_Water                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ANPC_Pawn_Wildlife_Parent_C::Play_Water_Splash_at_Water_Surface(class AFortWaterBodyActor* Water_Body, bool Param_Enter_Water)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Enter_Water = Param_Enter_Water;
