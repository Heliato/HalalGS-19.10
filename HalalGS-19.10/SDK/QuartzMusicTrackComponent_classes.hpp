...
public:
	...
	void OnQuartzClockDelegate(EQuartzCommandDelegateSubType EventType, class FName Param_Name);
	void OnQuartzQuantizationEvent(class FName Param_ClockName, EQuartzCommandQuantization QuantizationType, int32 NumBars, int32 Beat, float BeatFraction);
