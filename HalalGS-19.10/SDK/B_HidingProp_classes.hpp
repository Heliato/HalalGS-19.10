...
public:
	...
	void Allow_Cosmetics_For_Pawn(const class AFortPawn*& Param_Pawn, bool* Allow);
	...
	void Launch_Pickups(TArray<class AFortPickup*>& Param_Array, class AActor* Param_Pawn);
	...
	void StopHiding(const class AFortPawn* Param_Pawn);
	void StopHidingLoop();
	void Teleport(class AActor* Param_Pawn);
