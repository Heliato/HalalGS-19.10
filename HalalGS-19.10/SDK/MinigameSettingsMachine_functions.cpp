...
void AMinigameSettingsMachine_C::GetEndCallouts(class FString* Param_CustomVictoryCallout, class FString* Param_CustomDefeatCallout)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_CustomVictoryCallout != nullptr)
		*Param_CustomVictoryCallout = std::move(Parms.Param_CustomVictoryCallout);

	if (Param_CustomDefeatCallout != nullptr)
		*Param_CustomDefeatCallout = std::move(Parms.Param_CustomDefeatCallout);
}
...
void AMinigameSettingsMachine_C::Override_Custom_End_Callouts(const class FString& Param_DeviceVictoryCallout, const class FString& Param_DeviceDefeatCallout)
{
	static class UFunction* Func = nullptr;
