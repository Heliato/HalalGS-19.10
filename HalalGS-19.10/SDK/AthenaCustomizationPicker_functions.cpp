...
void UAthenaCustomizationPicker_C::NavigateDownFromSortAndFilter(EUINavigation Param_Navigation, class UWidget** NewParam)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UAthenaCustomizationPicker_C::NavigateUpFromPicker(EUINavigation Param_Navigation)
{
	static class UFunction* Func = nullptr;
...
// Function AthenaCustomizationPicker.AthenaCustomizationPicker_C.OnAlternateActionHoveredChanged__DelegateSignature
...
void UAthenaCustomizationPicker_C::OnAlternateActionHoveredChanged__DelegateSignature(bool bIsHovered)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaCustomizationPicker_C", "OnAlternateActionHoveredChanged__DelegateSignature");

	Params::AthenaCustomizationPicker_C_OnAlternateActionHoveredChanged__DelegateSignature Parms{};
