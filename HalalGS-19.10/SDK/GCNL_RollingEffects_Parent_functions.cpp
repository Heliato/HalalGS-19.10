...
// Parameters:
// class AActor*                           Param_PhysicsObject                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Size                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGCNL_RollingEffects_Parent_C::GetObjectSizeParam(class AActor* Param_PhysicsObject, int32* Size)
{
	static class UFunction* Func = nullptr;
...
void AGCNL_RollingEffects_Parent_C::GetSoundAsset(class AActor* Param_PhysicsObject, class USoundBase** Asset)
{
	static class UFunction* Func = nullptr;
